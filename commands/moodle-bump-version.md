---
name: moodle-bump-version
description: Bump version.php and add an upgrade.php step for a Moodle plugin.
argument-hint: "[plugin path] [reason] — e.g. local/attendance \"add status column\""
---
