...
- `moodle-upgrade-migration` — Use when upgrading a Moodle plugin across versions, fixing deprecated API usage, or migrating to Moodle 4.x/5.x conventions — print_error, add_to_log, formslib changes, external_api namespace, Hooks API, PSR-4 migration, and required upgrade.txt notes.
